...
crs::GpuProgram program(groupSize,groupCount,
  ...
  //
  "  READ_ONLY_BUFFER(0, float X[]; )           \n"
  "  READ_ONLY_BUFFER(1, float Y[]; )           \n"
  " WRITE_ONLY_BUFFER(2, float Z[]; )           \n"
  // ...
  "                                             \n"
  //
  // ... À COMPLÉTER {2} ...
...
// vecteurs ``X'', ``Y'' et ``Z''.
//
crs::GpuBuffer gpuX(elemCount*sizeof(X[0]));
crs::GpuBuffer gpuY(elemCount*sizeof(Y[0]));
crs::GpuBuffer gpuZ(elemCount*sizeof(Z[0]));
// ...
...
//
gpuX.fromHost(X.data());
gpuY.fromHost(Y.data());
// ...
...
//
program.buffer(0,gpuX)
       .buffer(1,gpuY)
       .buffer(2,gpuZ)
       .param_int(0,elemCount)
       .param_vec2(1,xFactor,yFactor)
       .call();
// ...
